...
aw_gl_func_pointer(clear_buffer_fi);
...
aw_gl_func_pointer(get_integer_64i_v);
...
aw_gl_func_pointer(get_double_i_v);
aw_gl_func_pointer(get_float_i_v);
...
aw_gl_func_pointer(get_transform_feedback_i64_v);
...
aw_gl_func_pointer(readn_pixels);
...
int load_gl_3_2_functions()
{
	...
	core_load_func(get_boolean_i_v, "glGetBooleani_v");
	...
	core_load_func(get_integer_i_v, "glGetIntegeri_v");
	...
	core_load_func(get_integer_64i_v, "glGetInteger64i_v");
...
int load_gl_4_1_functions()
{
	...
	core_load_func(get_double_i_v, "glGetDoublei_v");
	core_load_func(get_float_i_v, "glGetFloati_v");
...
int load_gl_4_5_functions()
{
	...
	core_load_func(get_transform_feedback_i64_v, "glGetTransformFeedbacki64_v");
...
ext::load_result load_functions_ext()
{
	...
	aw::gl::get_proc(get_integer_v, "glGetIntegerv");
	if(!get_integer_v) return ext::load_result(false, 1);
	aw::gl::get_proc(get_string_i, "glGetStringi");
