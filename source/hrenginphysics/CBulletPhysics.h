...
public:
	...
	virtual IPhysicsBody* createBody(const u32 modelId, Vector3d pos, u32 group = 0, u32 filters = 0);
	virtual IPhysicsBody* createBody(const char* modelName, Vector3d pos, u32 group = 0, u32 filters = 0);

	virtual IPhysicsPhantom* createPhantom(const u32 modelId, u32 group = 0, u32 filters = 0);
	virtual IPhysicsPhantom* createPhantom(const char* modelName, u32 group = 0, u32 filters = 0);
