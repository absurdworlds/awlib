...
aw_gl_func_pointer(get_tex_parameter_iiv);
aw_gl_func_pointer(get_tex_parameter_iuiv);
aw_gl_func_pointer(get_transform_feedback_varying);
aw_gl_func_pointer(get_uniform_uiv);
aw_gl_func_pointer(get_vertex_attrib_iiv);
aw_gl_func_pointer(get_vertex_attrib_iuiv);
...
aw_gl_func_pointer(tex_parameter_iiv);
aw_gl_func_pointer(tex_parameter_iuiv);
...
aw_gl_func_pointer(vertex_attrib_i1i);
aw_gl_func_pointer(vertex_attrib_i1iv);
aw_gl_func_pointer(vertex_attrib_i1ui);
aw_gl_func_pointer(vertex_attrib_i1uiv);
aw_gl_func_pointer(vertex_attrib_i2i);
aw_gl_func_pointer(vertex_attrib_i2iv);
aw_gl_func_pointer(vertex_attrib_i2ui);
aw_gl_func_pointer(vertex_attrib_i2uiv);
aw_gl_func_pointer(vertex_attrib_i3i);
aw_gl_func_pointer(vertex_attrib_i3iv);
aw_gl_func_pointer(vertex_attrib_i3ui);
aw_gl_func_pointer(vertex_attrib_i3uiv);
aw_gl_func_pointer(vertex_attrib_i4bv);
aw_gl_func_pointer(vertex_attrib_i4i);
aw_gl_func_pointer(vertex_attrib_i4iv);
aw_gl_func_pointer(vertex_attrib_i4sv);
aw_gl_func_pointer(vertex_attrib_i4ubv);
aw_gl_func_pointer(vertex_attrib_i4ui);
aw_gl_func_pointer(vertex_attrib_i4uiv);
aw_gl_func_pointer(vertex_attrib_i4usv);
...
decltype(get_active_uniform_block_iv) get_active_uniform_blockiv = 0;
aw_gl_func_pointer(get_active_uniform_name);
decltype(get_active_uniforms_iv) get_active_uniformsiv = 0;
...
aw_gl_func_pointer(vertex_attrib_p1ui);
aw_gl_func_pointer(vertex_attrib_p1uiv);
aw_gl_func_pointer(vertex_attrib_p2ui);
aw_gl_func_pointer(vertex_attrib_p2uiv);
aw_gl_func_pointer(vertex_attrib_p3ui);
aw_gl_func_pointer(vertex_attrib_p3uiv);
aw_gl_func_pointer(vertex_attrib_p4ui);
aw_gl_func_pointer(vertex_attrib_p4uiv);
...
decltype(read_n_pixels) readn_pixels = 0;
