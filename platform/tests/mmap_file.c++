...
#endif
int call_code(char* code)
{
	// char* rather than void*: going through void would be a second,
	// pointless conversion, which clang-tidy rightly objects to.
	auto func = reinterpret_cast<int(*)()>(code);
	return func();
}
} // namespace
