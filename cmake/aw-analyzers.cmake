...
# Wanted by clang-tidy, run-clang-tidy, iwyu and every editor going.
#
# CMake pre-declares this as an empty cache entry, so set(... CACHE ...)
# without FORCE is silently a no-op -- and FORCE would override someone
# who asked for it off. Write the normal variable instead, and only when
# nothing has been asked for: an explicit -D leaves the cache entry
...
if (AW_GCC_ANALYZER)
	...
	# Measured over this tree, two checks account for every false positive
