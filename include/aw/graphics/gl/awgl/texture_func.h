...
//------------------------------------------------------------------------------
inline void tex_parameter_f(GLenum target, GLenum pname, GLfloat param)
{
	::gl::tex_parameterf(target, pname, param);
}
inline void tex_parameter_fv(GLenum target, GLenum pname, const GLfloat* params)
{
...
inline void tex_parameter_iv(GLenum target, GLenum pname, const GLint* params)
{
	::gl::tex_parameteriv(target, pname, params);
}
inline void tex_parameteri_iv(GLenum target, GLenum pname, const GLint* params)
{
	::gl::tex_parameter_iiv(target, pname, params);
}
inline void tex_parameteri_uiv(GLenum target, GLenum pname, const GLuint* params)
{
