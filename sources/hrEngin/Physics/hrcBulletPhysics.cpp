...
hrcBulletPhysics::hrcBulletPhysics()
{	
...
u32 hrcBulletPhysics::MakeShape(hriPhysicsManager::PHYS_BUILTIN_SHAPES type, f32 x, f32 y, f32 z)
{
	//rewrite to switch
...
hriPhysicsPhantom* hrcBulletPhysics::CreatePhantom(const u32 shapeid) 
{
	...
	return new hrcPhysicsPhantom(collObject);
};

hriPhysicsObject* hrcBulletPhysics::CastRay(Vectorf3d from, Vectorf3d to)
{
	...
	{
		return (hriPhysicsObject*)resultCallback.m_collisionObject->getUserPointer();
	}

	return 0;
}

bool hrcBulletPhysics::Step()
{
